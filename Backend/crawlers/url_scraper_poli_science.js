...
const crawlPoliScience = async({ url }) =>{
    ...
    //    fs.appendFileSync('pup.json', `${data}\n`);
        if(element.attribs.href != undefined){
            if(element.attribs.href.startsWith("javascript:view")){ // 24 29
                ...
                url_list.push(`http://politics.cau.ac.kr/07_comm/comm_08a.php?idx=&p_idx=${trimmedLink}&s_kind=&s_scroll=&s_key=&p_page=1&code=b_13&p_listtype=&p_mode=view&mode=&p_pgfile=%2F07_comm%2Fcomm_08a.php`);
...
export default crawlPoliScience
