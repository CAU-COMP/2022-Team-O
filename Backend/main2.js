...
import crawlMechEngineering from "./url_scraper_mech_engineering.js";
import crawlPsychology from "./url_scraper_psychology.js";
import crawlBusiness from "./url_scraper_business.js";
import crawlElecEngineering from "./url_scraper_elec_engineering.js";
import crawlEnglish from "./url_scraper_English.js";
import crawlEnerEngineering from "./url_scraper_ener_engineering.js";
...
const res_MechEngineering = await crawlMechEngineering("url");
const res_Psychology = await crawlPsychology("url");
const res_Business = await crawlBusiness("url");
const res_ElecEngineering = await crawlElecEngineering("url");
const res_English = await crawlEnglish("url");
const res_EnerEngineering = await crawlEnerEngineering("url");
...
userDataBase.push({
    ...
    Korean: "true",
    MechEngineering: "true",
    Psychology: "true",
    Business: "true",
    ElecEngineering:"true",
    English:"true",
    EnerEngineering: "true",
